...
class SinaArticle extends article_1.Article {
    parseHtml(html) {
        ...
        if (result && result.groups) {
            seriesTitle = (_b = result.groups) === null || _b === void 0 ? void 0 : _b.title;
        }
        const article = dom.window.document.querySelectorAll('#sina_keyword_ad_area2 p');
        let sentences = [];
        Array.from(article).map((p) => {
            var _a;
            const paras = (_a = p === null || p === void 0 ? void 0 : p.textContent) === null || _a === void 0 ? void 0 : _a.replace('<br>', '\n').split(/\n/).filter((text) => !!text);
