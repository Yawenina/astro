...
class Article {
    constructor(title, href, seriesNo) {
        this.title = title;
        this.href = href;
        this.seriesNo = seriesNo;
    }
    ...
    generateMd(data) {
        ...
        const date = (0, dayjs_1.default)('2008-06-13 23:59:59').subtract(seriesNo, 'minute').format();
        const formatted = sentences === null || sentences === void 0 ? void 0 : sentences.map(text => /^\(\d+/.test(text) ? `### ${text}` : text);
        const md = `---
title: ${title}
slug: ${seriesNo}
authors: soilAstro
...
${formatted === null || formatted === void 0 ? void 0 : formatted.join('\n')}
  `;
